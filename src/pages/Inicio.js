...
function Inicio() {
    ...
    return (
        <div>
            <Row className='bg-primary py-4' style={{ marginTop: "-16px" }}>
                <Col xs="12">
                    <p className='p-0 m-0'>Nos ajude com a sua doação</p>
                </Col>
            </Row>
            <Row className='mb-5'>
                ...
                <Col md="6" className='mt-5 mt-md-0 ms-0 ms-lg-5' >
                    <Row className='justify-content-center'>
                        <Col md="12" className='d-flex flex-column'>
                            ...
                            <p className='mt-3 mt-md-4' style={paragrafoStyle}>Você já parou para pensar na diferença que podemos fazer quando nos unimos em prol de uma causa nobre? A RefugiHelp é uma ONG fictícia que tem como missão fundamental oferecer apoio e assistência a refugiados, proporcionando-lhes um novo começo e a chance de construir um futuro digno.</p>

                            <p style={paragrafoStyle}>Imbuída de um compromisso inabalável com a justiça social, a RefugiHelp não é apenas uma organização, mas sim uma família global, conectada pelo propósito de restaurar a esperança naqueles que enfrentaram os desafios mais assombrosos. Em nossa jornada, testemunhamos histórias de resiliência e coragem que inspiram cada passo que damos.</p>

                            <p style={paragrafoStyle}>Cada história que encontramos é uma narrativa de coragem e resiliência. Em meio às circunstâncias mais desafiadoras, testemunhamos a força interior daqueles que, apesar de terem enfrentado a adversidade, mantêm uma chama ardente de esperança. A RefugiHelp se coloca ao lado desses indivíduos, pronta para ser a ponte que os conduz a um futuro cheio de possibilidades.</p>

                            <Link to="/projetos"><button type="button" className="btn btn-dark mt-md-4 align-self-md-start ms-md-1 p-3 lead">Conheça Nossos Projetos</button></Link>
                        </Col>
                    </Row >
                </Col >
            </Row>
